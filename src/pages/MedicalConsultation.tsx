...
const MedicalConsultation = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFFADD] to-[#8ECDDD]/10">
      <Navbar />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center mb-6">
              <Button
                ...
                className="text-[#22668D] hover:bg-[#22668D]/10"
              >
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#22668D]">
      ...
      {/* Information Section */}
      <section className="section-padding bg-[#FFFADD]">
        <div className="container-custom max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-lg font-semibold mb-3 text-[#22668D]">Before Your Consultation</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-3 text-[#22668D]">During Your Consultation</h4>
              <ul className="space-y-2 text-gray-600">
          ...
          <div className="mt-8 p-6 bg-[#8ECDDD]/10 rounded-lg">
            <h4 className="text-lg font-semibold mb-3 text-[#22668D]">Important Notes</h4>
            <ul className="space-y-2 text-gray-600">
